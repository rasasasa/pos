...
<div class="wrapper">
  <header class="main-header">
    <a href="<?=base_url('dashboard')?>" class="logo">
      ...
      <span class="logo-lg"><b>POS</b>Cash-It</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Salles</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://riyan@cash-it.com">Cash-It</a>.</strong> All rightsreserved.
  </footer>
